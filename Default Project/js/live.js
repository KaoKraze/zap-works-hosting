...
(function () {
  ...
  const GRADS = [
    "linear-gradient(135deg,#8b3bff,#e935ff)",
  ...
  const VERIFIED =
    '<svg class="rbx-verified" viewBox="0 0 24 24" aria-hidden="true"><rect x="1.5" y="1.5" width="21" height="21" rx="6" fill="#8b3bff"/><path d="M7.2 12.6l3.4 3.4L16.8 9" stroke="#fff" stroke-width="2.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>';
  ...
  function renderGraph(history) {
    ...
    defs.innerHTML =
      '<linearGradient id="areaGrad" x1="0" y1="0" x2="0" y2="1">' +
        '<stop offset="0%" stop-color="#22e06b" stop-opacity="0.28"/>' +
        '<stop offset="100%" stop-color="#22e06b" stop-opacity="0"/>' +
      "</linearGradient>" +
      '<linearGradient id="lineGrad" x1="0" y1="0" x2="1" y2="0">' +
        '<stop offset="0%" stop-color="#22e06b"/>' +
        '<stop offset="55%" stop-color="#3b82ff"/>' +
