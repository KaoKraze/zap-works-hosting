...
(function () {
  ...
  function heroStart() {
    if (heroStarted || heroData.length <= 3) return;
    heroStarted = true;
  ...
  function renderHero(games) {
    ...
    // build the three frames only once
    if (!host.querySelector(".hero__float") && heroData.length) {
      host.innerHTML =
        '<div class="hero__float">' +
          '<div class="hero__fcard hero__fcard--0">' + heroCardHTML(heroData[0] || games[0]) + "</div>" +
          '<div class="hero__fcard hero__fcard--1">' + heroCardHTML(heroData[1] || games[0]) + "</div>" +
          '<div class="hero__fcard hero__fcard--2">' + heroCardHTML(heroData[2] || games[0]) + "</div>" +
        "</div>";
